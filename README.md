...
Once the for loop finished, I coded the LCD to print “Push the Button to Dance Again :)” and then created a while loop that continued running until the button was pushed (see code for specifics of how I coded this part). Once it was pushed, I cleared the LCD screen and allowed the entire loop() process to repeat. 
